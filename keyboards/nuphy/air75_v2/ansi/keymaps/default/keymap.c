...
[0] = LAYOUT_75_ansi(
    ...
    KC_LCTL,    KC_LALT,   KC_LGUI,                                         KC_SPC,                             KC_GLOBE,  MO(1),      KC_RCTL,                 KC_LEFT,    KC_DOWN,    KC_RGHT),

// layer Mac Fn
[1] = LAYOUT_75_ansi(
    _______,    KC_BRID,    KC_BRIU,    KC_MCTL,   MAC_SEARCH, MAC_VOICE,   MAC_DND,   KC_MPRV,    KC_MPLY,     KC_MNXT,   KC_MUTE,    KC_VOLD,    KC_VOLU,     SYS_PRT,    _______,    _______,
